...
namespace RockPaperScissors.Core.Abstractions
{
    public abstract class GameElementBase
    {
        ...
        /// <summary>
        /// We use a  base class to identify the "rules" for a given element. E.g Rock beats scissors. However the underlying base class has no understanding of what data types are passed to it.
        /// </summary>
        ...
        /// <summary>
        /// Returns the name of the current concretion of the abstract class.
        /// </summary>
        public string Name => this.GetType().Name;

        /// <summary>
        /// Returns the string to the image for the element.
        /// </summary>
